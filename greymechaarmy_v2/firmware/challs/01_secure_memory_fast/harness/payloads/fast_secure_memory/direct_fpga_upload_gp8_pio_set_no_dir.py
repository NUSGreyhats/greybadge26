...
print("DIRECT_FPGA_UPLOAD_GP8_PIO_SET_NO_DIR_START")
...
"""
    ...
    for bit in [0, 1, 0, 1, 0]:
        ...
        time.sleep(0.35)
        value = read_pmod()
        print("pio-set-nodir gp8", bit, "addr", 30 | bit, "value", value, fmt(value))
finally:
    if sm:
        sm.deinit()
    if gp8_dio:
...
print("DIRECT_FPGA_UPLOAD_GP8_PIO_SET_NO_DIR_DONE")
