...
print("DIRECT_FPGA_UPLOAD_GP8_PIO_SET_START")
...
try:
    ...
    # Secure-memory mode: Overlay.set_mode((0, 1, 0)) maps to GP15=0, GP14=1, GP13=0.
...
"""
    ...
    for bit in [0, 1, 0, 1, 0]:
        ...
        time.sleep(0.35)
        value = read_pmod()
        print("pio-set gp8", bit, "addr", 30 | bit, "value", value, fmt(value))
finally:
    if sm:
        sm.deinit()
    if gp8_dio:
...
print("DIRECT_FPGA_UPLOAD_GP8_PIO_SET_DONE")
