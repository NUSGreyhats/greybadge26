import time
from apps.music.old import buzz_funcs

# By sayomaki
# Animation left as an exercise to the reader
tones = {
    "0":0,
    ...
    'C6':1047,'C#6':1078,'D6':1175,'D#6':1205,'E6':1319,'F6':1357,'F#6':1440,'G6':1568,'G#6':1661,'A6':1760,'A#6':1865,'B6':1976,
...
song = [
    ('D#4', 1), ('F4', 1), ('F#4', 1), ('G#4', 1), ('A#4', 2), ('D#5', 1), ('C#5', 1),
    ('A#4', 2), ('D#4', 2), ('A#4', 1), ('G#4', 1), ('F#4', 1), ('F4', 1),
    ('D#4', 1), ('F4', 1), ('F#4', 1), ('G#4', 1), ('A#4', 2), ('G#4', 1), ('F#4', 1), 
    ('F4', 1), ('D#4', 1), ('F4', 1), ('F#4', 1), ('F4', 1), ('D#4', 1), ('D4', 1), ('F4', 1),

    ('D#4', 1), ('F4', 1), ('F#4', 1), ('G#4', 1), ('A#4', 2), ('D#5', 1), ('C#5', 1),
    ('A#4', 2), ('D#4', 2), ('A#4', 1), ('G#4', 1), ('F#4', 1), ('F4', 1),
    ('D#4', 1), ('F4', 1), ('F#4', 1), ('G#4', 1), ('A#4', 2), ('G#4', 1), ('F#4', 1), 
    ('F4', 2), ('F#4', 2), ('G#4', 2), ('A#4', 2),

    ('C#6', 1), ('D#6', 1), ('A#5', 1), ('G#5', 1), ('A#5', 2), ('G#5', 1), ('A#5', 1),
    ('C#6', 1), ('D#6', 1), ('A#5', 1), ('G#5', 1), ('A#5', 2), ('G#5', 1), ('A#5', 1),
    ('G#5', 1), ('F#5', 1), ('F5', 1), ('C#5', 1), ('D#5', 2), ('C#5', 1), ('D#5', 1),
    ('F5', 1), ('F#5', 1), ('G#5', 1), ('A#5', 1), ('D#5', 2), ('A#5', 1), ('C#6', 1),

    ('C#6', 1), ('D#6', 1), ('A#5', 1), ('G#5', 1), ('A#5', 2), ('G#5', 1), ('A#5', 1),
    ('C#6', 1), ('D#6', 1), ('A#5', 1), ('G#5', 1), ('A#5', 2), ('D#6', 1), ('F6', 1),
    ('F#6', 1), ('F6', 1), ('D#6', 1), ('C#6', 1), ('A#5', 2), ('G#5', 1), ('A#5', 1),
    ('G#5', 1), ('F#5', 1), ('F5', 1), ('C#5', 1), ('D#5', 2)
]

def play_bad_apple(hw_state):
    print("buzz")
